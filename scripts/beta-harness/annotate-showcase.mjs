...
function renderHtml(capturedAt) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    * { box-sizing:border-box; }
    ...
    <footer>Captured ${esc(capturedAt)} UTC · ${esc(BASE)} · Chrome headless ${VIEWPORT.width}×${VIEWPORT.height} @${SCALE}x · Angular 20.3.27 · live local Nuxeo on :8080 · generated by scripts/beta-harness/annotate-showcase.mjs</footer>
  </div></body></html>`;
}
