...
**Ten of the fourteen hold as written. Two were wrong and are withdrawn, one holds for a different
reason, one is unconfirmed.** That base rate is the argument for re-verifying rather than trusting a
