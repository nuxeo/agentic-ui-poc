...
| **F13** | **WRONG — withdrawn**       | Re-checked 2026-09-26. The absent local `target/` said only that nobody had run Maven **on a laptop**; it runs in CI on every pull request. `2026.0.1-20260926071953-BUILD-1109` was built and published to preprod by run 36226401180 and is live on the listing. What is still unverified is **installing** the ZIP on a server — a separate step, and the one R7 turns on.                                                                                                                                                                                                                   |
