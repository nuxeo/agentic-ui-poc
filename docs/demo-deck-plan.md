...
which also records the Part 6 re-verification behind the runbook corrections: **ten of the fourteen
"do not demo" entries hold as written, F5 and F6 were wrong and are withdrawn, F7 is right for a
different reason, F11 is unconfirmed.**
