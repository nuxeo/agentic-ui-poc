...
| ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Angular 19 → 20 upgrade is a project in its own right | **Evaporates, and inverts into an advantage.** A new app starts on Angular 20.3.25, Material 20.2.14, TypeScript 5.8.3 — the exact versions HFA builds against. Better alignment than a migration could achieve, at no upgrade cost |
