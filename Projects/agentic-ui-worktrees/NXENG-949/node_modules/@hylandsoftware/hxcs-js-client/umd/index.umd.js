(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.hxcs = {}, global.globalAxios));
})(this, (function (exports, globalAxios) { 'use strict';
     ...
     *
     * The version of the OpenAPI document: 2.1.479
     *
     *
    ...
    const LONG_POLL_TIMEOUT_MARGIN_MS = 60_000;
    function deriveTimeout(url) {
        if (!url)
            return DEFAULT_READ_TIMEOUT_MS;
        const match = url.match(/[?&]timeout=(\d+)/);
        if (match) {
            return parseInt(match[1], 10) * 1000 + LONG_POLL_TIMEOUT_MARGIN_MS;
        }
        return DEFAULT_READ_TIMEOUT_MS;
    }
    class BaseAPI {
        ...
        constructor(configuration, basePath = BASE_PATH, axios = globalAxios) {
            ...
            // Interceptor added as we do not want encoded '/' characters or repeated '/' through the URL
            axios.interceptors.request.use((req) => {
                if (req.url) {
                    // replace encoded '/' characters with literal '/' characters
                    req.url = req.url.replace(/%2F/g, "/");
                    // replace repeated '/' characters in the middle of the URL with a single '/', skipping 'http(s)://'
                    req.url = req.url.replace(/(?<!https?:)\/\/+/g, "/");
                }
                if (req.timeout === undefined) {
                    req.timeout = deriveTimeout(req.url);
                }
                return req;
            });
        }
     ...
     */
    /**
     * The current status of the application of the ACE rule.
     * @export
     * @enum {string}
     */
    const Status = {
     ...
     * @export
     */
    const BulkImportApiAxiosParamCreator = function (configuration) {
        return {
            /**
             *
             * @summary Abort an ongoing import job.
             * @param {string} jobId The Bulk Import Job id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            abortJob: async (jobId, options = {}) => {
                // verify required parameter 'jobId' is not null or undefined
                assertParamExists('abortJob', 'jobId', jobId);
                const localVarPath = `/api/import/jobs/{jobId}/abort`
            ...
            /**
             *
             * @summary Creates a bulk import Job.
             * @param {BulkImportModelDTO} [bulkImportModelDTO]
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            createJob: async (bulkImportModelDTO, options = {}) => {
                ...
                let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
                localVarRequestOptions.data = serializeDataIfNeeded(bulkImportModelDTO, localVarRequestOptions, configuration);
                return {
                    url: toPathString(localVarUrlObj),
                    options: localVarRequestOptions,
                };
            ...
            /**
             *
             * @summary Deletes a bulk import Job.
             * @param {string} jobId The Bulk Import Job id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            deleteJobById: async (jobId, options = {}) => {
                // verify required parameter 'jobId' is not null or undefined
                assertParamExists('deleteJobById', 'jobId', jobId);
                const localVarPath = `/api/import/job/{jobId}/purge`
                    .replace(`{${"jobId"}}`, encodeURIComponent(String(jobId)));
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
            ...
            /**
             *
             * @summary Lists a specific import job with its status.
             * @param {string} jobId The Bulk Import Job id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getJobById: async (jobId, options = {}) => {
                ...
                const localVarPath = `/api/import/job/{jobId}/status`
                    .replace(`{${"jobId"}}`, encodeURIComponent(String(jobId)));
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
            ...
            /**
             *
             * @summary Lists all bulk import jobs with their statuses.
             * @param {number} [limit] The maximum number of Bulk jobs to return.
             * @param {number} [offset] The initial document offset for pagination support.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getJobs: async (limit, offset, options = {}) => {
                const localVarPath = `/api/import/jobs`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
                if (configuration) {
            ...
            /**
             *
             * @summary Renews temporary credentials for a Job.
             * @param {string} jobId The Bulk Import Job id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            renewJobCredentialsByJobId: async (jobId, options = {}) => {
                // verify required parameter 'jobId' is not null or undefined
                assertParamExists('renewJobCredentialsByJobId', 'jobId', jobId);
                const localVarPath = `/api/import/job/{jobId}/refresh-credentials`
                    .replace(`{${"jobId"}}`, encodeURIComponent(String(jobId)));
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @param {string} jobId The Bulk Import Job id.
             * @param {string} [format] Format in which the report is to be generated. Currently supporting onlyjson
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            reportJobById: async (jobId, format, options = {}) => {
                // verify required parameter 'jobId' is not null or undefined
                assertParamExists('reportJobById', 'jobId', jobId);
                const localVarPath = `/api/import/job/{jobId}/report`
                    .replace(`{${"jobId"}}`, encodeURIComponent(String(jobId)));
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @param {string} jobId The Bulk Import Job id.
             * @param {boolean} [dryRun] Whether to just validate the job details, without applying it.
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            startJobById: async (jobId, dryRun, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'jobId' is not null or undefined
                assertParamExists('startJobById', 'jobId', jobId);
                const localVarPath = `/api/import/job/{jobId}/start`
                    .replace(`{${"jobId"}}`, encodeURIComponent(String(jobId)));
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
     ...
     * @export
     */
    const BulkImportApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async abortJob(jobId, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.abortJob(jobId, options);
             ...
             * @throws {RequiredError}
             */
            async createJob(bulkImportModelDTO, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createJob(bulkImportModelDTO, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async deleteJobById(jobId, options) {
             ...
             * @throws {RequiredError}
             */
            async getJobs(limit, offset, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getJobs(limit, offset, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async renewJobCredentialsByJobId(jobId, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.renewJobCredentialsByJobId(jobId, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async reportJobById(jobId, format, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.reportJobById(jobId, format, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async startJobById(jobId, dryRun, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.startJobById(jobId, dryRun, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
     ...
     * @export
     */
    const BulkImportApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            abortJob(jobId, options) {
                return localVarFp.abortJob(jobId, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Creates a bulk import Job.
             ...
             * @throws {RequiredError}
             */
            createJob(bulkImportModelDTO, options) {
                return localVarFp.createJob(bulkImportModelDTO, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Deletes a bulk import Job.
             ...
             * @throws {RequiredError}
             */
            getJobs(limit, offset, options) {
                return localVarFp.getJobs(limit, offset, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Renews temporary credentials for a Job.
             ...
             * @throws {RequiredError}
             */
            renewJobCredentialsByJobId(jobId, options) {
                return localVarFp.renewJobCredentialsByJobId(jobId, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Generates a report.
             ...
             * @throws {RequiredError}
             */
            reportJobById(jobId, format, options) {
                return localVarFp.reportJobById(jobId, format, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Starts a bulk import Job.
             ...
             * @throws {RequiredError}
             */
            startJobById(jobId, dryRun, hXCSREPOSITORY, options) {
                return localVarFp.startJobById(jobId, dryRun, hXCSREPOSITORY, options).then((request) => request(axios, basePath));
            },
        };
    };
    /**
     ...
     * @extends {BaseAPI}
     */
    class BulkImportApi extends BaseAPI {
        /**
         *
         * @summary Abort an ongoing import job.
         * @param {string} jobId The Bulk Import Job id.
         ...
         */
        abortJob(jobId, options) {
            return BulkImportApiFp(this.configuration).abortJob(jobId, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Creates a bulk import Job.
         ...
         */
        createJob(bulkImportModelDTO, options) {
            return BulkImportApiFp(this.configuration).createJob(bulkImportModelDTO, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Deletes a bulk import Job.
         ...
         */
        deleteJobById(jobId, options) {
            return BulkImportApiFp(this.configuration).deleteJobById(jobId, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Lists a specific import job with its status.
         ...
         */
        getJobById(jobId, options) {
            return BulkImportApiFp(this.configuration).getJobById(jobId, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Lists all bulk import jobs with their statuses.
         ...
         */
        getJobs(limit, offset, options) {
            return BulkImportApiFp(this.configuration).getJobs(limit, offset, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Renews temporary credentials for a Job.
         ...
         */
        renewJobCredentialsByJobId(jobId, options) {
            return BulkImportApiFp(this.configuration).renewJobCredentialsByJobId(jobId, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Generates a report.
         ...
         */
        reportJobById(jobId, format, options) {
            return BulkImportApiFp(this.configuration).reportJobById(jobId, format, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Starts a bulk import Job.
         ...
         */
        startJobById(jobId, dryRun, hXCSREPOSITORY, options) {
            return BulkImportApiFp(this.configuration).startJobById(jobId, dryRun, hXCSREPOSITORY, options).then((request) => request(this.axios, this.basePath));
        }
    }
    /**
    ...
    const CheckInApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            checkin: async (docId, minor, hXCSREPOSITORY, options = {}) => {
    ...
    const CheckInApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async checkin(docId, minor, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.checkin(docId, minor, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const CopyApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            copy: async (docId, hXCSREPOSITORY, copyCommand, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
    ...
    const CopyApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async copy(docId, hXCSREPOSITORY, copyCommand, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.copy(docId, hXCSREPOSITORY, copyCommand, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const DocumentApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @param {boolean} [enforceSysName] Prevent sys_name from being renamed.
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {{ [key: string]: any; }} [requestBody]
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            createDocumentUnderParentById: async (docId, enforceSysName, hXCSREPOSITORY, requestBody, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
                ...
                // http bearer authentication required
                await setBearerAuthToObject(localVarHeaderParameter, configuration);
                if (enforceSysName !== undefined) {
                    localVarQueryParameter['enforceSysName'] = enforceSysName;
                }
                if (hXCSREPOSITORY !== undefined && hXCSREPOSITORY !== null) {
                    localVarHeaderParameter['HXCS-REPOSITORY'] = String(hXCSREPOSITORY);
                }
             ...
             * @throws {RequiredError}
             */
            createDocumentUnderParentByPath: async (docPath, enforceSysName, hXCSREPOSITORY, requestBody, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            deleteDocumentById: async (docId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            deleteDocumentByPath: async (docPath, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docPath' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getDocumentAncestors: async (docId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getDocumentById: async (docId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getDocumentByPath: async (docPath, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docPath' is not null or undefined
             ...
             * @param {string} docId The document id.
             * @param {string} [condition] Condition (an HXQL predicate).
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {object} [body]
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            patchDocumentById: async (docId, condition, hXCSREPOSITORY, body, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            patchDocumentByPath: async (docPath, condition, hXCSREPOSITORY, body, options = {}) => {
                // verify required parameter 'docPath' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            updateDocumentById: async (docId, condition, hXCSREPOSITORY, requestBody, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            updateDocumentByPath: async (docPath, condition, hXCSREPOSITORY, requestBody, options = {}) => {
                // verify required parameter 'docPath' is not null or undefined
    ...
    const DocumentApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async createDocumentUnderParentById(docId, enforceSysName, hXCSREPOSITORY, requestBody, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createDocumentUnderParentById(docId, enforceSysName, hXCSREPOSITORY, requestBody, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async createDocumentUnderParentByPath(docPath, enforceSysName, hXCSREPOSITORY, requestBody, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createDocumentUnderParentByPath(docPath, enforceSysName, hXCSREPOSITORY, requestBody, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async deleteDocumentById(docId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.deleteDocumentById(docId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async deleteDocumentByPath(docPath, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.deleteDocumentByPath(docPath, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getDocumentAncestors(docId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getDocumentAncestors(docId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getDocumentById(docId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getDocumentById(docId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getDocumentByPath(docPath, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getDocumentByPath(docPath, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async patchDocumentById(docId, condition, hXCSREPOSITORY, body, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.patchDocumentById(docId, condition, hXCSREPOSITORY, body, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async patchDocumentByPath(docPath, condition, hXCSREPOSITORY, body, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.patchDocumentByPath(docPath, condition, hXCSREPOSITORY, body, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async updateDocumentById(docId, condition, hXCSREPOSITORY, requestBody, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.updateDocumentById(docId, condition, hXCSREPOSITORY, requestBody, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async updateDocumentByPath(docPath, condition, hXCSREPOSITORY, requestBody, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.updateDocumentByPath(docPath, condition, hXCSREPOSITORY, requestBody, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const DocumentApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            createDocumentUnderParentById(docId, enforceSysName, hXCSREPOSITORY, requestBody, options) {
                return localVarFp.createDocumentUnderParentById(docId, enforceSysName, hXCSREPOSITORY, requestBody, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Creates a document under parent with given path.
             ...
             * @throws {RequiredError}
             */
            createDocumentUnderParentByPath(docPath, enforceSysName, hXCSREPOSITORY, requestBody, options) {
                return localVarFp.createDocumentUnderParentByPath(docPath, enforceSysName, hXCSREPOSITORY, requestBody, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Deletes the document with given id.
             ...
             * @throws {RequiredError}
             */
            patchDocumentById(docId, condition, hXCSREPOSITORY, body, options) {
                return localVarFp.patchDocumentById(docId, condition, hXCSREPOSITORY, body, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Patches the document with given path.
             ...
             * @throws {RequiredError}
             */
            patchDocumentByPath(docPath, condition, hXCSREPOSITORY, body, options) {
                return localVarFp.patchDocumentByPath(docPath, condition, hXCSREPOSITORY, body, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Updates the document with given id.
             ...
             * @throws {RequiredError}
             */
            updateDocumentById(docId, condition, hXCSREPOSITORY, requestBody, options) {
                return localVarFp.updateDocumentById(docId, condition, hXCSREPOSITORY, requestBody, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Updates the document with given path.
             ...
             * @throws {RequiredError}
             */
            updateDocumentByPath(docPath, condition, hXCSREPOSITORY, requestBody, options) {
                return localVarFp.updateDocumentByPath(docPath, condition, hXCSREPOSITORY, requestBody, options).then((request) => request(axios, basePath));
            },
        };
    };
    /**
    ...
    class DocumentApi extends BaseAPI {
        ...
        createDocumentUnderParentById(docId, hXCSREPOSITORY, requestBody, options) {
            return DocumentApiFp(this.configuration).createDocumentUnderParentById(docId, false, hXCSREPOSITORY, requestBody, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Creates a document under parent with given path.
        ...
        createDocumentUnderParentByPath(docPath, hXCSREPOSITORY, requestBody, options) {
            return DocumentApiFp(this.configuration).createDocumentUnderParentByPath(docPath, false, hXCSREPOSITORY, requestBody, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Deletes the document with given id.
         ...
         */
        patchDocumentByPath(docPath, condition, hXCSREPOSITORY, body, options) {
            return DocumentApiFp(this.configuration).patchDocumentByPath(docPath, condition, hXCSREPOSITORY, body, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Updates the document with given id.
    ...
    const DocumentPermissionsApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            fulleffectiveacl: async (docId, usernames, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            fulleffectivepermissions: async (docId, usernames, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
    ...
    const DocumentPermissionsApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async fulleffectiveacl(docId, usernames, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.fulleffectiveacl(docId, usernames, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             * Fetch the full list of effective permissions on the document for the given list of users.
             ...
             * @throws {RequiredError}
             */
            async fulleffectivepermissions(docId, usernames, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.fulleffectivepermissions(docId, usernames, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const DownloadApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            downloadByIdAndXPath: async (docId, propertyXPathAndFilename, inline, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            downloadInfoByIdAndXPath: async (docId, propertyXPathAndFilename, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            downloadUrlByIdAndXPath: async (docId, propertyXPathAndFilename, expiration, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
    ...
    const DownloadApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async downloadByIdAndXPath(docId, propertyXPathAndFilename, inline, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.downloadByIdAndXPath(docId, propertyXPathAndFilename, inline, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async downloadInfoByIdAndXPath(docId, propertyXPathAndFilename, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.downloadInfoByIdAndXPath(docId, propertyXPathAndFilename, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async downloadUrlByIdAndXPath(docId, propertyXPathAndFilename, expiration, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.downloadUrlByIdAndXPath(docId, propertyXPathAndFilename, expiration, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const EmbeddingsApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @param {string} docId The document id.
             * @param {string} embeddingId The document id.
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getEmbedding: async (docId, embeddingId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
                assertParamExists('getEmbedding', 'docId', docId);
                // verify required parameter 'embeddingId' is not null or undefined
                assertParamExists('getEmbedding', 'embeddingId', embeddingId);
                const localVarPath = `/api/documents/{docId}/embedding/{embeddingId}`
                    .replace(`{${"docId"}}`, encodeURIComponent(String(docId)))
                    .replace(`{${"embeddingId"}}`, encodeURIComponent(String(embeddingId)));
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
                if (configuration) {
    ...
    const EmbeddingsApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async getEmbedding(docId, embeddingId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getEmbedding(docId, embeddingId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const EmbeddingsApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            getEmbedding(docId, embeddingId, hXCSREPOSITORY, options) {
                return localVarFp.getEmbedding(docId, embeddingId, hXCSREPOSITORY, options).then((request) => request(axios, basePath));
            },
        };
    };
    /**
     ...
     * @extends {BaseAPI}
     */
    class EmbeddingsApi extends BaseAPI {
        /**
         *
         * @summary Get an embedding by id.
         * @param {string} docId The document id.
         ...
         */
        getEmbedding(docId, embeddingId, hXCSREPOSITORY, options) {
            return EmbeddingsApiFp(this.configuration).getEmbedding(docId, embeddingId, hXCSREPOSITORY, options).then((request) => request(this.axios, this.basePath));
        }
    }
    /**
    ...
    const FeatureFlagsApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            getFeatureFlagByKey: async (key, options = {}) => {
    ...
    const FeatureFlagsApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async getFeatureFlagByKey(key, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getFeatureFlagByKey(key, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const GreetingApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async helloUser(options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.helloUser(options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const GroupApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            getGroupById: async (groupId, options = {}) => {
            ...
            /**
             *
             * @summary Returns the list of groups which name or label contains the given string. Given name part for searching is null or empty, then return all groups
             * @param {string} name Part of the group name or label
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            searchGroups: async (name, options = {}) => {
    ...
    const GroupApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async searchGroups(name, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.searchGroups(name, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const ModelApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            getModel: async (hXCSREPOSITORY, options = {}) => {
            ...
            /**
             *
             * @summary Returns the model specific to a project for the repository.
             * @param {string} projectId
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getModelItemsForProject: async (projectId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'projectId' is not null or undefined
                assertParamExists('getModelItemsForProject', 'projectId', projectId);
             ...
             * @throws {RequiredError}
             */
            patchModel: async (validateOnly, hXCSREPOSITORY, body, options = {}) => {
                const localVarPath = `/api/repository/model`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @throws {RequiredError}
             */
            setModel: async (validateOnly, hXCSREPOSITORY, model, options = {}) => {
                const localVarPath = `/api/repository/model`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @throws {RequiredError}
             */
            setModelItemsForProject: async (projectId, validateOnly, hXCSREPOSITORY, model, options = {}) => {
                // verify required parameter 'projectId' is not null or undefined
    ...
    const ModelApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async getModel(hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getModel(hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getModelItemsForProject(projectId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getModelItemsForProject(projectId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async patchModel(validateOnly, hXCSREPOSITORY, body, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.patchModel(validateOnly, hXCSREPOSITORY, body, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async setModel(validateOnly, hXCSREPOSITORY, model, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.setModel(validateOnly, hXCSREPOSITORY, model, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async setModelItemsForProject(projectId, validateOnly, hXCSREPOSITORY, model, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.setModelItemsForProject(projectId, validateOnly, hXCSREPOSITORY, model, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const ModelApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            getModelItemsForProject(projectId, hXCSREPOSITORY, options) {
                return localVarFp.getModelItemsForProject(projectId, hXCSREPOSITORY, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Patches the model for the repository.
    ...
    class ModelApi extends BaseAPI {
         ...
         */
        getModelItemsForProject(projectId, hXCSREPOSITORY, options) {
            return ModelApiFp(this.configuration).getModelItemsForProject(projectId, hXCSREPOSITORY, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Patches the model for the repository.
    ...
    const MoveApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            move: async (docId, condition, hXCSREPOSITORY, moveCommand, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
    ...
    const MoveApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async move(docId, condition, hXCSREPOSITORY, moveCommand, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.move(docId, condition, hXCSREPOSITORY, moveCommand, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const MoveApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            move(docId, condition, hXCSREPOSITORY, moveCommand, options) {
                return localVarFp.move(docId, condition, hXCSREPOSITORY, moveCommand, options).then((request) => request(axios, basePath));
            },
        };
    };
    /**
    ...
    const QueryApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            getDocumentsByAdvancedQuery: async (advancedQuery, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            getDocumentsByNamedQuery: async (namedQuery, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            getDocumentsByQuery: async (query, options = {}) => {
             ...
             * @param {VectorQuery} [vectorQuery]
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getEmbeddingsByQuery: async (vectorQuery, options = {}) => {
                const localVarPath = `/api/query/embeddings`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
                if (configuration) {
                ...
                let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
                localVarRequestOptions.data = serializeDataIfNeeded(vectorQuery, localVarRequestOptions, configuration);
                return {
                    url: toPathString(localVarUrlObj),
                    options: localVarRequestOptions,
                };
             ...
             * @throws {RequiredError}
             */
            getNamedQuery: async (namedQuery, options = {}) => {
            ...
            /**
             *
             * @summary Terms aggregation query on a given property.
             * @param {TermsAggregationsQuery} [termsAggregationsQuery]
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            queryTermsAggregation: async (termsAggregationsQuery, options = {}) => {
                const localVarPath = `/api/query/termsAggregation`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
                if (configuration) {
                ...
                let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
                localVarRequestOptions.data = serializeDataIfNeeded(termsAggregationsQuery, localVarRequestOptions, configuration);
                return {
                    url: toPathString(localVarUrlObj),
                    options: localVarRequestOptions,
                };
             ...
             * @param {boolean} [waitForAudit] Wait for audit (deprecated, unused).
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            waitForFullTextSearchIndexing: async (refresh, timeout, waitForAudit, hXCSREPOSITORY, options = {}) => {
    ...
    const QueryApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async getDocumentsByAdvancedQuery(advancedQuery, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getDocumentsByAdvancedQuery(advancedQuery, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getDocumentsByNamedQuery(namedQuery, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getDocumentsByNamedQuery(namedQuery, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getDocumentsByQuery(query, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getDocumentsByQuery(query, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getEmbeddingsByQuery(vectorQuery, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getEmbeddingsByQuery(vectorQuery, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getNamedQueries(options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getNamedQueries(options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getNamedQuery(namedQuery, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getNamedQuery(namedQuery, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async queryTermsAggregation(termsAggregationsQuery, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.queryTermsAggregation(termsAggregationsQuery, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async waitForFullTextSearchIndexing(refresh, timeout, waitForAudit, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.waitForFullTextSearchIndexing(refresh, timeout, waitForAudit, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const QueryApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            getEmbeddingsByQuery(vectorQuery, options) {
                return localVarFp.getEmbeddingsByQuery(vectorQuery, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Returns the named query definition names.
             ...
             * @throws {RequiredError}
             */
            queryTermsAggregation(termsAggregationsQuery, options) {
                return localVarFp.queryTermsAggregation(termsAggregationsQuery, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Waits for for full text search indexing.
    ...
    class QueryApi extends BaseAPI {
         ...
         */
        getEmbeddingsByQuery(vectorQuery, options) {
            return QueryApiFp(this.configuration).getEmbeddingsByQuery(vectorQuery, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Returns the named query definition names.
         ...
         */
        queryTermsAggregation(termsAggregationsQuery, options) {
            return QueryApiFp(this.configuration).queryTermsAggregation(termsAggregationsQuery, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Waits for for full text search indexing.
    ...
    const RenditionConfigurationsApiAxiosParamCreator = function (configuration) {
        return {
            /**
             *
             * @summary Get the rendition configuration
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getRenditionsConfig: async (hXCSREPOSITORY, options = {}) => {
                const localVarPath = `/api/repository/renditions`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
                if (configuration) {
            ...
            /**
             *
             * @summary Get the rendition configuration for a specific project
             * @param {string} projectId The project id.
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            getRenditionsForProject: async (projectId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'projectId' is not null or undefined
                assertParamExists('getRenditionsForProject', 'projectId', projectId);
            ...
            /**
             *
             * @summary Update the rendition configuration for a specific project
             * @param {string} projectId The project id.
             ...
             * @throws {RequiredError}
             */
            putRenditions: async (projectId, validateOnly, hXCSREPOSITORY, renditionsConfig, options = {}) => {
                // verify required parameter 'projectId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            putRenditionsConfig: async (validateOnly, hXCSREPOSITORY, renditionsConfig, options = {}) => {
                const localVarPath = `/api/repository/renditions`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
    ...
    const RenditionConfigurationsApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async getRenditionsConfig(hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getRenditionsConfig(hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getRenditionsForProject(projectId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getRenditionsForProject(projectId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async putRenditions(projectId, validateOnly, hXCSREPOSITORY, renditionsConfig, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.putRenditions(projectId, validateOnly, hXCSREPOSITORY, renditionsConfig, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async putRenditionsConfig(validateOnly, hXCSREPOSITORY, renditionsConfig, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.putRenditionsConfig(validateOnly, hXCSREPOSITORY, renditionsConfig, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const RenditionConfigurationsApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            getRenditionsConfig(hXCSREPOSITORY, options) {
                return localVarFp.getRenditionsConfig(hXCSREPOSITORY, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Get the rendition configuration for a specific project
             ...
             * @throws {RequiredError}
             */
            getRenditionsForProject(projectId, hXCSREPOSITORY, options) {
                return localVarFp.getRenditionsForProject(projectId, hXCSREPOSITORY, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Update the rendition configuration for a specific project
             ...
             * @throws {RequiredError}
             */
            putRenditionsConfig(validateOnly, hXCSREPOSITORY, renditionsConfig, options) {
                return localVarFp.putRenditionsConfig(validateOnly, hXCSREPOSITORY, renditionsConfig, options).then((request) => request(axios, basePath));
            },
        };
    };
    /**
    ...
    class RenditionConfigurationsApi extends BaseAPI {
         ...
         */
        getRenditionsConfig(hXCSREPOSITORY, options) {
            return RenditionConfigurationsApiFp(this.configuration).getRenditionsConfig(hXCSREPOSITORY, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Get the rendition configuration for a specific project
         ...
         */
        getRenditionsForProject(projectId, hXCSREPOSITORY, options) {
            return RenditionConfigurationsApiFp(this.configuration).getRenditionsForProject(projectId, hXCSREPOSITORY, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Update the rendition configuration for a specific project
         ...
         */
        putRenditionsConfig(validateOnly, hXCSREPOSITORY, renditionsConfig, options) {
            return RenditionConfigurationsApiFp(this.configuration).putRenditionsConfig(validateOnly, hXCSREPOSITORY, renditionsConfig, options).then((request) => request(this.axios, this.basePath));
        }
    }
    /**
    ...
    const RenditionsApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            createRendition: async (docId, hXCSREPOSITORY, rendition, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getRendition: async (docId, renditionId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getRenditions: async (docId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'docId' is not null or undefined
    ...
    const RenditionsApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async createRendition(docId, hXCSREPOSITORY, rendition, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createRendition(docId, hXCSREPOSITORY, rendition, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getRendition(docId, renditionId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getRendition(docId, renditionId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getRenditions(docId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getRenditions(docId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const SecurityApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            getExternalUserRelations: async (policyName, hXCSREPOSITORY, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            getExternalUserRelationsStatus: async (policyName, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'policyName' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getSecurityPolicies: async (hXCSREPOSITORY, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            patchSecurityPolicies: async (validateOnly, hXCSREPOSITORY, body, options = {}) => {
                const localVarPath = `/api/repository/security/policies`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @param {string} policyName The policy name.
             * @param {string} [hXCSREPOSITORY] The repository id.
             * @param {ExternalUserRelationsSecurityPolicyRelations} [externalUserRelationsSecurityPolicyRelations]
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            setExternalUserRelations: async (policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options = {}) => {
                // verify required parameter 'policyName' is not null or undefined
                ...
                let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
                localVarRequestOptions.data = serializeDataIfNeeded(externalUserRelationsSecurityPolicyRelations, localVarRequestOptions, configuration);
                return {
                    url: toPathString(localVarUrlObj),
                    options: localVarRequestOptions,
                };
             ...
             * @throws {RequiredError}
             */
            setSecurityPolicies: async (validateOnly, hXCSREPOSITORY, requestBody, options = {}) => {
                const localVarPath = `/api/repository/security/policies`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @throws {RequiredError}
             */
            setSecurityPoliciesForProject: async (projectId, validateOnly, hXCSREPOSITORY, requestBody, options = {}) => {
                // verify required parameter 'projectId' is not null or undefined
    ...
    const SecurityApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async getExternalUserRelations(policyName, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getExternalUserRelations(policyName, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getExternalUserRelationsStatus(policyName, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getExternalUserRelationsStatus(policyName, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getSecurityPolicies(hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getSecurityPolicies(hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async patchSecurityPolicies(validateOnly, hXCSREPOSITORY, body, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.patchSecurityPolicies(validateOnly, hXCSREPOSITORY, body, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async setExternalUserRelations(policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.setExternalUserRelations(policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async setSecurityPolicies(validateOnly, hXCSREPOSITORY, requestBody, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.setSecurityPolicies(validateOnly, hXCSREPOSITORY, requestBody, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async setSecurityPoliciesForProject(projectId, validateOnly, hXCSREPOSITORY, requestBody, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.setSecurityPoliciesForProject(projectId, validateOnly, hXCSREPOSITORY, requestBody, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const SecurityApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            setExternalUserRelations(policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options) {
                return localVarFp.setExternalUserRelations(policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options).then((request) => request(axios, basePath));
            },
            /**
             *
             * @summary Sets the security policies for the repository. Changes to fixed security policies (such as acl, lock and retention) will be ignored.
    ...
    class SecurityApi extends BaseAPI {
         ...
         */
        setExternalUserRelations(policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options) {
            return SecurityApiFp(this.configuration).setExternalUserRelations(policyName, hXCSREPOSITORY, externalUserRelationsSecurityPolicyRelations, options).then((request) => request(this.axios, this.basePath));
        }
        /**
         *
         * @summary Sets the security policies for the repository. Changes to fixed security policies (such as acl, lock and retention) will be ignored.
    ...
    const UploadApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            complete: async (id, uploadFileInfo, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            getUploadInfo: async (id, options = {}) => {
                // verify required parameter 'id' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            renewCredentials: async (id, options = {}) => {
                // verify required parameter 'id' is not null or undefined
             ...
             * @param {string} [bodyEncoding] The body encoding (only base64 allowed).
             ...
             * @throws {RequiredError}
             */
            upload: async (bodyEncoding, chunkCount, chunkIndex, chunked, encoding, fileName, id, mimeType, body, options = {}) => {
                ...
                if (bodyEncoding !== undefined) {
                    localVarQueryParameter['bodyEncoding'] = bodyEncoding;
                }
    ...
    const UploadApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async complete(id, uploadFileInfo, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.complete(id, uploadFileInfo, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
            ...
            async createUpload(options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createUpload(options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
            ...
            async deleteUpload(id, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.deleteUpload(id, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getUploadInfo(id, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getUploadInfo(id, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async renewCredentials(id, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.renewCredentials(id, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             * Upload can be done in several parts, chunk by chunk.
             ...
             * @throws {RequiredError}
             */
            async upload(bodyEncoding, chunkCount, chunkIndex, chunked, encoding, fileName, id, mimeType, body, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.upload(bodyEncoding, chunkCount, chunkIndex, chunked, encoding, fileName, id, mimeType, body, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const UploadApiFactory = function (configuration, basePath, axios) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            upload(bodyEncoding, chunkCount, chunkIndex, chunked, encoding, fileName, id, mimeType, body, options) {
                return localVarFp.upload(bodyEncoding, chunkCount, chunkIndex, chunked, encoding, fileName, id, mimeType, body, options).then((request) => request(axios, basePath));
            },
        };
    };
    /**
    ...
    const UserApiAxiosParamCreator = function (configuration) {
        return {
            ...
            /**
             *
             * @summary Returns the list of users which username or email address contains the given string
             * @param {string} name Part of the user name or email
             * @param {*} [options] Override http request option.
             * @throws {RequiredError}
             */
            searchUsersByName: async (name, options = {}) => {
                // verify required parameter 'name' is not null or undefined
    ...
    const UserApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async searchUsersByName(name, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.searchUsersByName(name, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const VersionApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            restoreVersion: async (versionId, hXCSREPOSITORY, options = {}) => {
    ...
    const VersionApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async restoreVersion(versionId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.restoreVersion(versionId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    const VocabularyApiAxiosParamCreator = function (configuration) {
        return {
             ...
             * @throws {RequiredError}
             */
            createVocabulary: async (hXCSREPOSITORY, vocabulary, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            createVocabularyEntry: async (sysvocabId, hXCSREPOSITORY, vocabularyEntryRequest, options = {}) => {
             ...
             * @throws {RequiredError}
             */
            deleteVocabulary: async (sysvocabId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'sysvocabId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            deleteVocabularyEntry: async (sysvocabId, sysvocabKey, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'sysvocabId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getVocabularyEntries: async (sysvocabId, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'sysvocabId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getVocabularyEntry: async (sysvocabId, sysvocabKey, hXCSREPOSITORY, options = {}) => {
                // verify required parameter 'sysvocabId' is not null or undefined
             ...
             * @throws {RequiredError}
             */
            getVocabularyList: async (hXCSREPOSITORY, options = {}) => {
                const localVarPath = `/api/vocabularies`;
                // use dummy base URL string because the URL constructor only accepts absolute URLs.
                const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
                let baseOptions;
             ...
             * @throws {RequiredError}
             */
            updateVocabularyEntry: async (sysvocabId, hXCSREPOSITORY, vocabularyEntryRequest, options = {}) => {
                // verify required parameter 'sysvocabId' is not null or undefined
    ...
    const VocabularyApiFp = function (configuration) {
        ...
        return {
             ...
             * @throws {RequiredError}
             */
            async createVocabulary(hXCSREPOSITORY, vocabulary, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createVocabulary(hXCSREPOSITORY, vocabulary, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async createVocabularyEntry(sysvocabId, hXCSREPOSITORY, vocabularyEntryRequest, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.createVocabularyEntry(sysvocabId, hXCSREPOSITORY, vocabularyEntryRequest, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async deleteVocabulary(sysvocabId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.deleteVocabulary(sysvocabId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async deleteVocabularyEntry(sysvocabId, sysvocabKey, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.deleteVocabularyEntry(sysvocabId, sysvocabKey, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getVocabularyEntries(sysvocabId, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getVocabularyEntries(sysvocabId, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getVocabularyEntry(sysvocabId, sysvocabKey, hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getVocabularyEntry(sysvocabId, sysvocabKey, hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async getVocabularyList(hXCSREPOSITORY, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.getVocabularyList(hXCSREPOSITORY, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
            /**
             *
             ...
             * @throws {RequiredError}
             */
            async updateVocabularyEntry(sysvocabId, hXCSREPOSITORY, vocabularyEntryRequest, options) {
                const localVarAxiosArgs = await localVarAxiosParamCreator.updateVocabularyEntry(sysvocabId, hXCSREPOSITORY, vocabularyEntryRequest, options);
                return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
            },
        };
    };
    ...
    exports.BulkImportApi = BulkImportApi;
    exports.BulkImportApiAxiosParamCreator = BulkImportApiAxiosParamCreator;
    exports.BulkImportApiFactory = BulkImportApiFactory;
    exports.BulkImportApiFp = BulkImportApiFp;
    exports.CheckInApi = CheckInApi;
    exports.CheckInApiAxiosParamCreator = CheckInApiAxiosParamCreator;
    exports.CheckInApiFactory = CheckInApiFactory;
    exports.CheckInApiFp = CheckInApiFp;
    exports.Configuration = Configuration;
    exports.CopyApi = CopyApi;
    exports.CopyApiAxiosParamCreator = CopyApiAxiosParamCreator;
    exports.CopyApiFactory = CopyApiFactory;
    exports.CopyApiFp = CopyApiFp;
    ...
    exports.DocumentPermissionsApi = DocumentPermissionsApi;
    exports.DocumentPermissionsApiAxiosParamCreator = DocumentPermissionsApiAxiosParamCreator;
    exports.DocumentPermissionsApiFactory = DocumentPermissionsApiFactory;
    exports.DocumentPermissionsApiFp = DocumentPermissionsApiFp;
    exports.DownloadApi = DownloadApi;
    exports.DownloadApiAxiosParamCreator = DownloadApiAxiosParamCreator;
    exports.DownloadApiFactory = DownloadApiFactory;
    exports.DownloadApiFp = DownloadApiFp;
    ...
    exports.GreetingApi = GreetingApi;
    exports.GreetingApiAxiosParamCreator = GreetingApiAxiosParamCreator;
    exports.GreetingApiFactory = GreetingApiFactory;
    exports.GreetingApiFp = GreetingApiFp;
    ...
    exports.ModelApiAxiosParamCreator = ModelApiAxiosParamCreator;
    exports.ModelApiFactory = ModelApiFactory;
    exports.ModelApiFp = ModelApiFp;
    exports.MoveApi = MoveApi;
    exports.MoveApiAxiosParamCreator = MoveApiAxiosParamCreator;
    exports.MoveApiFactory = MoveApiFactory;
    exports.MoveApiFp = MoveApiFp;
    ...
    exports.RenditionConfigurationsApi = RenditionConfigurationsApi;
    exports.RenditionConfigurationsApiAxiosParamCreator = RenditionConfigurationsApiAxiosParamCreator;
    exports.RenditionConfigurationsApiFactory = RenditionConfigurationsApiFactory;
    exports.RenditionConfigurationsApiFp = RenditionConfigurationsApiFp;
    exports.RenditionsApi = RenditionsApi;
    exports.RenditionsApiAxiosParamCreator = RenditionsApiAxiosParamCreator;
    exports.RenditionsApiFactory = RenditionsApiFactory;
    exports.RenditionsApiFp = RenditionsApiFp;
    ...
    exports.UploadAttachStatusEnum = UploadAttachStatusEnum;
    exports.UploadStatusEnum = UploadStatusEnum;
    ...
    exports.VocabularyApiAxiosParamCreator = VocabularyApiAxiosParamCreator;
    exports.VocabularyApiFactory = VocabularyApiFactory;
    exports.VocabularyApiFp = VocabularyApiFp;
