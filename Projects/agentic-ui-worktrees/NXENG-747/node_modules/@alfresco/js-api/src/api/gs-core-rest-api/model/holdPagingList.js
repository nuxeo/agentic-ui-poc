...
exports.HoldPagingList = void 0;
const content_rest_api_1 = require("../../content-rest-api");
const holdEntry_1 = require("./holdEntry");
class HoldPagingList {
    constructor(input) {
        if (input) {
            Object.assign(this, input);
            this.pagination = input.pagination ? new content_rest_api_1.Pagination(input.pagination) : undefined;
            if (input.entries) {
                this.entries = input.entries.map((item) => new holdEntry_1.HoldEntry(item));
            }
        }
    }
}
exports.HoldPagingList = HoldPagingList;
