...
const auth_rest_api_1 = require("../api/auth-rest-api");
...
class Oauth2Auth extends alfrescoApiClient_1.AlfrescoApiClient {
    constructor(config, alfrescoApi, httpClient) {
        ...
        this.pathMatcher = new path_matcher_1.PathMatcher();
    ...
    isPublicUrl() {
        ...
        if (Array.isArray(publicUrls)) {
            return publicUrls.length > 0 && publicUrls.some((urlPattern) => this.pathMatcher.match(window.location.href, urlPattern));
        }
        return false;
    }
    ...
    isRedirectionUrl() {
        var _a;
        return ((_a = window.location.hash) === null || _a === void 0 ? void 0 : _a.split('&')[0].indexOf('session_state')) === -1;
    }
    genNonce() {
        let text = '';
    ...
    removeHashFromSilentIframe() {
        ...
        if (iframe === null || iframe === void 0 ? void 0 : iframe.contentWindow.location.hash) {
    ...
    createIframe() {
        ...
        this.iFrameHashListener = () => {
            const silentRefreshTokenIframe = document.getElementById('silent_refresh_token_iframe');
    ...
    grantPasswordLogin(username, password, resolve, reject) {
        ...
        const contentTypes = ['application/x-www-form-urlencoded'];
        const accepts = ['application/json'];
        const promise = this.callCustomApi(this.discovery.tokenEndpoint, 'POST', {}, {}, headerParams, formParams, {}, contentTypes, accepts).then((data) => {
            ...
            var _a;
            if (((_a = error.error) === null || _a === void 0 ? void 0 : _a.status) === 401 || error.status === 401) {
                this.emit('unauthorized');
            }
            this.emit('error');
            reject(error.error);
        });
        return this.addPromiseListeners(promise, new eventemitter3_1.EventEmitter());
    }
    pollingRefreshToken() {
    ...
    refreshToken() {
        ...
        const promise = new Promise((resolve, reject) => {
            this.callCustomApi(this.discovery.tokenEndpoint, 'POST', {}, {}, headerParams, formParams, {}, contentTypes, accepts).then((data) => {
                this.setToken(data.access_token, data.refresh_token);
                resolve(data);
            }, (error) => {
                var _a;
                if (((_a = error.error) === null || _a === void 0 ? void 0 : _a.status) === 401) {
                    this.emit('unauthorized');
                }
                this.emit('error');
                reject(error.error);
    ...
    exchangeTicketListener(alfrescoApi) {
        this.on('token_issued', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const authContentApi = new auth_rest_api_1.AuthenticationApi(alfrescoApi);
...
//# sourceMappingURL=../../../../../lib/js-api/src/authentication/oauth2Auth.js.map