...
| Attachment | Shows |
| --- | --- |
| `NXENG-759-before-01-context.png` | View containing reported SVG |
| `NXENG-759-before-02-focused.png` | Logo / SVG region (accessible name review) |
| `NXENG-759-before.webm` | Recording: navigate to Browse and focus the reported control |
