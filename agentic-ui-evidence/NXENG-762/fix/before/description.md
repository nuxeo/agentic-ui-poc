...
| Attachment | Shows |
| --- | --- |
| `NXENG-762-before-01-context.png` | View containing reported SVG |
| `NXENG-762-before-02-focused.png` | Logo / SVG region (accessible name review) |
| `NXENG-762-before.webm` | Recording: navigate to Browse and focus the reported control |
