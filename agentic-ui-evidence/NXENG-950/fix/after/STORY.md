...
| Recording | `NXENG-950-after.webm` (chapters in `chapters.vtt`) |
...
### 2. Login controls sit inside landmarks  _(pass)_

_The username/password fields flagged by a11y-scout must not sit outside landmarks_

Proves: **AC-1**

- [pass] mat-form-field infix is contained by a landmark
- [pass] copyright footer uses contentinfo landmark
...
### 3. axe region rule on the login surface  _(pass)_

_Confirm the reported axe `region` violation is gone without breaking the form_

Proves: **AC-2**

- [pass] axe region rule has no violations
