...
**Verdict:** FAIL — 9/11 checks across 4 scene(s)
...
| Recording | `NXENG-748-before.webm` (chapters in `chapters.vtt`) |

## Failed checks

- Scene 2 ([Act 2] Tab to Username and confirm focus is not clipped) — **username field uses login-field-username styling**: {"centerOnInput":true,"wrapperOverflow":"visible","scrollMarginTop":"0px","hasUsernameFieldClass":false}
- Scene 2 ([Act 2] Tab to Username and confirm focus is not clipped) — **username input has scroll-margin for focus visibility**: 0px
...
### 2. Tab to Username and confirm focus is not clipped  _(2 failed)_
...
- [FAIL] username field uses login-field-username styling — {"centerOnInput":true,"wrapperOverflow":"visible","scrollMarginTop":"0px","hasUsernameFieldClass":false}
- [FAIL] username input has scroll-margin for focus visibility — 0px
