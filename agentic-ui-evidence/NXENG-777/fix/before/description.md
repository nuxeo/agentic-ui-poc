...
| Attachment | Shows |
| --- | --- |
| `NXENG-777-before-01-browse-with-shell.png` | Browse with app shell sidebar |
| `NXENG-777-before-02-nav-link-focused.png` | Keyboard focus on sidebar Browse nav link |
| `NXENG-777-before.webm` | Recording: navigate to Browse and focus the reported control |
