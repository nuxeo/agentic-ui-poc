...
| Attachment | Shows |
| --- | --- |
| `NXENG-785-before-01-browse-with-shell.png` | Browse with app shell sidebar |
| `NXENG-785-before-02-nav-link-focused.png` | Keyboard focus on sidebar Browse nav link |
| `NXENG-785-before.webm` | Recording: navigate to Browse and focus the reported control |
