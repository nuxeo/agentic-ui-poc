...
| Attachment | Shows |
| --- | --- |
| `NXENG-795-before-01-context.png` | Document detail header action toolbar |
| `NXENG-795-before-02-focused.png` | Keyboard focus on header action button (style_focus_visible) |
| `NXENG-795-before.webm` | Recording: navigate to Document detail and focus the reported control |
