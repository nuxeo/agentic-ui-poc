...
| Attachment | Shows |
| --- | --- |
| `NXENG-787-before-01-browse-with-shell.png` | Browse with app shell sidebar |
| `NXENG-787-before-02-nav-link-focused.png` | Keyboard focus on sidebar Browse nav link |
| `NXENG-787-before.webm` | Recording: navigate to Browse and focus the reported control |
