...
**Verdict:** FAIL — 8/9 checks across 4 scene(s)
...
| Recording | `NXENG-946-before.webm` (chapters in `chapters.vtt`) |

## Failed checks

- Scene 2 ([Act 2] Hyland brand link landmark containment) — **Hyland brand link is contained by a landmark**: brand is not inside a landmark (parent chain ends at DIV)
...
### 2. Hyland brand link landmark containment  _(1 failed)_

_The logo link axe flagged as outside any region landmark_

Proves: **AC-1**

- [FAIL] Hyland brand link is contained by a landmark — brand is not inside a landmark (parent chain ends at DIV)
