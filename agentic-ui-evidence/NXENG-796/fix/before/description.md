...
| Attachment | Shows |
| --- | --- |
| `NXENG-796-before-01-context.png` | Document detail header action toolbar |
| `NXENG-796-before-02-focused.png` | Keyboard focus on header action button (style_focus_visible) |
| `NXENG-796-before.webm` | Recording: navigate to Document detail and focus the reported control |
