...
| ------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ARender | `docker compose -f arender-docker-compose.yml up -d` | The document viewer. Setup: [`docs/arender-setup.md`](../../docs/arender-setup.md) — copy [`.env.arender.example`](../../.env.arender.example) to `.env.arender` first |
