...
| Dependency Vulnerability | **Implemented** differently              | [`.github/dependabot.yml`](../../.github/dependabot.yml), the `supply-chain` gate, and the `code-scanning` gate over CodeQL, which has run since 2026-07-24 |
