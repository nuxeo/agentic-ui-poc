...
| ---------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------ |
| **Layer 0 configuration**    | Theme tokens, branding, languages, feature toggles in `bootstrap.json`            | Rebrand with no code and no rebuild; in a location the installer is **configured not to overwrite** | **Shipped**                    |
