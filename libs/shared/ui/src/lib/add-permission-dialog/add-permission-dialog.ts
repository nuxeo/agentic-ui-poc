  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <div class="time-frame-section">
        <!-- A caption for a radio group is not a <label>: a label points at one control,
             so the group is named with aria-labelledby instead. -->
        <span id="add-permission-time-frame-label" class="field-label">Time Frame</span>
        <mat-radio-group
          [(ngModel)]="timeFrame"
          class="time-frame-radios"
          aria-labelledby="add-permission-time-frame-label"
        >
      ...
      @if (sendNotify) {
        ...
        <div class="notify-section">
          <label class="field-label" for="add-permission-notify-comment">Notification email</label>
          <mat-form-field appearance="outline" class="full-width">
            <textarea
              id="add-permission-notify-comment"
              matInput
