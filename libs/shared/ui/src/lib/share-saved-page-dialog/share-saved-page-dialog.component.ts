...
export interface ShareSavedPageDialogData {
  title: string;
  id: string;
}

@Component({
  selector: 'lib-share-saved-page-dialog',
  standalone: true,
  imports: [
    MatDialogModule,
    MatButtonModule,
  ...
  templateUrl: './share-saved-page-dialog.component.html',
  styleUrl: './share-saved-page-dialog.component.scss',
})
export class ShareSavedPageDialogComponent implements OnInit {
  readonly dialogRef = inject(
    MatDialogRef<ShareSavedPageDialogComponent, PermissionEntry[] | null>,
  );
  readonly data = inject<ShareSavedPageDialogData>(MAT_DIALOG_DATA);
