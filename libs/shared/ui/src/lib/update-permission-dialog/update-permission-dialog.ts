    ...
    <mat-dialog-content>
      ...
      @if (!isExternal) {
        <div class="time-frame-section">
          ...
          <span id="update-permission-time-frame-label" class="field-label">Time Frame</span>
          <mat-radio-group
            [(ngModel)]="timeFrame"
            class="time-frame-radios"
            aria-labelledby="update-permission-time-frame-label"
          >
      ...
      @if (isExternal || sendNotify) {
        <div class="notify-section">
          <label class="field-label" for="update-permission-notify-comment">
            Notification email
          </label>
          <mat-form-field appearance="outline" class="full-width">
            <textarea
              id="update-permission-notify-comment"
              matInput
